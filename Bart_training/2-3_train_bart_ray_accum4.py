...
def train_func():
    ...
    # Define training arguments with gradient accumulation (4 steps)
    training_args = TrainingArguments(
        ...
        fp16=True,
        report_to="wandb",
        run_name="2-3) Ray_2GPU_accum4",  # Must match RunConfig.name
...
if __name__ == "__main__":
    ...
    trainer = TorchTrainer(
        ...
        run_config=RunConfig(
            name="2-3) Ray_2GPU_accum4",  # Must match run_name
