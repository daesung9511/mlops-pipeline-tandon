...
def train_func():
    ...
    # Define training arguments (no gradient accumulation)
    training_args = TrainingArguments(
        ...
        fp16=True,
        report_to="wandb",
        run_name="2-1) Ray_2GPU_basic",  # Matches the run name with Ray config name
...
if __name__ == "__main__":
    ...
    trainer = TorchTrainer(
        ...
        run_config=RunConfig(
            name="2-1) Ray_2GPU_basic",  # Matches run_name
