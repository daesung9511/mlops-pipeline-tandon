...
def train_func():
    ...
    # Define training arguments for FSDP strategy
    training_args = TrainingArguments(
        ...
        gradient_accumulation_steps=1,  # accum=1 for comparison
        num_train_epochs=5,
        weight_decay=0.01,
        save_total_limit=2,
        ...
        fp16=True,
        report_to="wandb",
        run_name="4-1) Ray_FSDP",  # Must match RunConfig.name
...
if __name__ == "__main__":
    ...
    trainer = TorchTrainer(
        ...
        run_config=RunConfig(
            name="4-1) Ray_FSDP",  # Must match run_name
